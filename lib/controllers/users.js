...
module.exports = Router()
  ...
  .post('/sessions', async (req, res, next) => {
    try {
      ...
      res
        ...
        .json(user); // attach wristband to wrist
    } catch (e) {
      next(e);
    }
  })
  ...
  .put('/:id', [authenticate, authorizeUser], async (req, res, next) => {
    try {
      const updatedUser = await User.update(req.user.email, req.body.currentStoryId);
